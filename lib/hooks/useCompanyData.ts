...
// Called from the public /apply/[token] flow after a valid
// submission. Returns false if the cap has already been hit,
// so the caller can show the "position closed" page.
